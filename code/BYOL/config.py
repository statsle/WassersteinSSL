...
def parse_arg():
    ...
    parser.add_argument('--model_name', default='BYOLplus', help='the name of models', choices=['BYOLplus'])
    ...
    parser.add_argument('--momentum', default=0.99, type=float, help='momentum of updating key encoder (default: 0.999)')
    ...
    args.save_name_pre = '{}_{}_{}_{}_{}_{}_{}_{}_{}_{}'.format(args.model_name, args.seed, args.dataset, args.hidden_dim, args.prej_dim, args.predictor_dim, args.batch_size, args.epochs, args.lambd_max, args.lambd_min)
